...
This is a fork of the [original project](https://github.com/pema99/UnityShaderParser/) designed to support incremental updates for interactive use cases such as text editing.
